...
namespace OE.NIK.ImPro.Logic.UI.Models
{
    ...
    public abstract class BaseImageProcesser
    {
        ...
        protected BaseImageProcesser(Bitmap sourceImage)
        {
            ...
            CreateBitmapDataFromSource(sourceImage);
            ImageStride = BitmapDataFromSource.Stride;
            Scan0IntPtr = BitmapDataFromSource.Scan0;

            // Todo: call the function that consumes and process the image
            // TODO: every child instance should unlock bits => sourceImage.UnlockBits(BitmapDataFromSource); !!!
        }
        ...
        /// </summary>
        public BitmapData BitmapDataFromSource { get; internal set; }
        ...
        /// <summary>
        /// Locks the bits of the given bitmap image and add it to <see cref="BitmapDataFromSource"/> property for further processing
        /// </summary>
        /// <param name="sourceImage">The source of the image as Bitmap</param>
        internal void CreateBitmapDataFromSource(Bitmap sourceImage)
        {
            BitmapDataFromSource = sourceImage.LockBits(
